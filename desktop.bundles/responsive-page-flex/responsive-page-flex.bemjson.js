    ...
    content: [
        {
            ...
            content: [
                ...
                /*- content-wrap */
                {
                    block: 'content-wrap-flex',
                    content: [
                        {
                            block: 'aside-nav-wrap-flex',
                            content: []
                        },
                        {
                            elem: 'inner',
                                                            ...
                                                            content: [
                                                                {
                                                                    ...
                                                                    content: [
                                                                        ...
                                                                        /*--- rest items */
                                                                        {
                                                                            ...
                                                                            tag: 'li',
                                                                            elemMods: { rest: true },
                                                                            mix: { block: 'overflow', mods: { y: 'auto' } },
                                                                            content: [
                                                                                {
                                                                                    block: 'persons-list',
                                                                                    mods: { 'rest-wrap': true },
                                                                                    ...
                                                                                    ].map(function(item){item.tag = 'li'; return item; })
                                                                                }
                                                                            ]
                                                                        }
                                                                    ]
